...
layui.define([], function (exports) {
	 ...
	 */
	fsConfig["global"] = {
		"servletUrl":"http://localhost", //异步请求地址,本地工程可以不填
		"loginUrl" : "/login", //登录url
		"imageUrl":CTX + "/upload/kindupload",
		"uploadUrl":CTX + "upload/file.html",
		...
		"page" : { //分页配置
			...
			"limit":20,//每页分页数量。默认20
			"limits":[20,30,50,100]//每页数据选择项，默认[10,20,30,50,100]
		}
	};
